...
void setMotorDirection(uint8_t direction)
{
	...
	if(direction==FORWARD)
	{
		...
		HAL_GPIO_WritePin(H_Bridge1_Control2_GPIO_Port,H_Bridge1_Control1_Pin,0);
		HAL_GPIO_WritePin(H_Bridge2_Control1_GPIO_Port,H_Bridge1_Control1_Pin,1);
		HAL_GPIO_WritePin(H_Bridge2_Control2_GPIO_Port,H_Bridge1_Control1_Pin,0);
	}
	else if(direction==REVERSE)
	{
		HAL_GPIO_WritePin(H_Bridge1_Control1_GPIO_Port,H_Bridge1_Control1_Pin,0);
		HAL_GPIO_WritePin(H_Bridge1_Control2_GPIO_Port,H_Bridge1_Control1_Pin,1);
		HAL_GPIO_WritePin(H_Bridge2_Control1_GPIO_Port,H_Bridge1_Control1_Pin,0);
		HAL_GPIO_WritePin(H_Bridge2_Control2_GPIO_Port,H_Bridge1_Control1_Pin,1);
	}
